...
<body>
    ...
    <div class="container myrelative">
        ...
        <div class="card bg-light mt-5">
            <div class="card-body">
                <form style="max-width: 300px;" method="post" action="tUpdatePwd">
                	<div class="errorTip">${requestScope.errorCode}</div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="oldpwd" placeholder="原始密码">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="newpwd1" placeholder="新密码">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="newpwd2" placeholder="新密码">
                    </div>
